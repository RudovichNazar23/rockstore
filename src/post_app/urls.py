...
urlpatterns = [
    ...
    path("user_posts/<int:pk>/", login_required(UserPostsView.as_view()), name="user_posts"),
    ...
    path("post/<int:pk>/comments/", login_required(PostCommentsView.as_view()), name="post_comments"),
    ...
    path("user_comments/<int:pk>/", login_required(UserCommentsView.as_view()), name="user_comments"),
    ...
    path("user_reposts/<int:pk>/", login_required(UserRepostsView.as_view()), name="user_reposts"),
